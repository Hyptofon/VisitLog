...
export function JournalTypeButton({ onClick, className, icon: Icon, title, description }: JournalTypeButtonProps) {
    return (
        <Button
            onClick={onClick}
            ...
            size="lg"
        >
            <div className={`text-left w-full ${Icon ? 'flex items-center gap-4' : ''}`}>
